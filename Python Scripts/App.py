...
image_path = r'Images/image_bg.jpg'  # Replace this with the path to your image file
...
def welcome_page():
    ...
    selected = option_menu(
        ...
        icons=[r"Images/house", r"Images/briefcase", r"Images/person-lines-fill"],
        menu_icon="cast",
        default_index=0,
...
def data_science_page():
    ...
    selected = option_menu(
        ...
        icons=["", r"Images/briefcase", r"Images/person-lines-fill"],
        menu_icon="cast",
        default_index=0,
        orientation="horizontal",
    )
